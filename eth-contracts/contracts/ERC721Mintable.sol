...
contract Pausable is Ownable {
    ...
    function setPaused(bool state) public onlyOwner {
        require(_paused != state, "New state doesn't change anything.");
        _paused = state;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != msg.sender, "You cannot transfer your tokens to yourself.");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(this.ownerOf(tokenId) == msg.sender, "You must be the owner of the contract.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Only the token owner can transfer their token.");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "Cannot transfer token to invalid address.");
...
contract HouseToken is ERC721Metadata("House Token", "HT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
